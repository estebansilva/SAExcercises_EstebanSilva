...
import Clase6.Constants.AccountConstants;
import Clase6.Pages.*;
...
public class RegisterAccountHelper extends BaseTest {
    ...
    public MyAccountPage registerNewAccount() throws InterruptedException {
        ...
        Assert.assertTrue(authenticationPage.getNavigationPanelPositionText().equals("Authentication"), "No se encuentra en la pagina de authenticación");
